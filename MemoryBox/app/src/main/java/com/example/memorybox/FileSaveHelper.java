 ...
 * </br>
 * How to Use it-
 * Call {@linkplain com.burhanrashid52.photoediting.FileSaveHelper#createFile(String, OnFileCreateResult)}
 * if file is created you would receive it's file path and Uri
 * and after you are done with File call {@linkplain com.burhanrashid52.photoediting.FileSaveHelper#notifyThatFileIsNowPubliclyAvailable(ContentResolver)}
 * </br>
 * Remember! in order to shutdown executor call {@linkplain com.burhanrashid52.photoediting.FileSaveHelper#addObserver(LifecycleOwner)} or
 * create object with the {@linkplain com.burhanrashid52.photoediting.FileSaveHelper#FileSaveHelper(AppCompatActivity)}
 */
